...
4. Create self-signed certificates for the services you want to run
    ...
    ./create-domain-cert.sh otherservice other.domain.lab
    ```
    The rootCA will be stored in `~/.ssl/`, and the domain certificates will be stored in `./someservice/certs/` and `otherservice/certs/`  
